    ...
    return TextProductModel.model_validate(
        {
            ...
            "nicedate": product_obj.get_nicedate() if hasattr(product_obj, "get_nicedate") else None,  # type: ignore[union-attr]
            "main_headline": product_obj.get_main_headline("") if hasattr(product_obj, "get_main_headline") else "",  # type: ignore[union-attr]
            ...
            "is_correction": product_obj.is_correction() if hasattr(product_obj, "is_correction") else None,  # type: ignore[union-attr]
            "is_resent": product_obj.is_resent() if hasattr(product_obj, "is_resent") else None,  # type: ignore[union-attr]
            "attn_wfo": product_obj.parse_attn_wfo() if hasattr(product_obj, "parse_attn_wfo") else [],  # type: ignore[union-attr]
            "attn_rfc": product_obj.parse_attn_rfc() if hasattr(product_obj, "parse_attn_rfc") else [],  # type: ignore[union-attr]
        },
    )
