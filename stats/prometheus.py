...
class PrometheusMetricsExporter:
    """Exports NWWS2MQTT statistics as Prometheus metrics."""
    ...
    def __init__(self, stats_collector: StatsCollector, port: int = 8080, update_interval: int = 30):
        ...
        logger.info("Prometheus metrics exporter initialized", 
                   port=port, update_interval=update_interval)
    ...
    def _init_metrics(self) -> None:
        ...
        self.product_types_total = create_counter(
            'nwws2mqtt_product_types_total',
            'Total count by product type',
    ...
    def _update_output_handler_metrics(self, stats: ApplicationStats) -> None:
        ...
        for handler_name, handler_stats in stats.output_handlers.items():
            ...
            self.output_handler_status.labels(**labels).set(
                1 if handler_stats.is_connected else 0
            )
