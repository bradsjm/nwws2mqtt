...
class NWWSClient:
    ...
    def __init__(self, config: Config) -> None:
        ...
        self.xmlstream: Optional[XmlStream] = None
        self.housekeeping_task: Optional[LoopingCall] = None
    ...
    def _join_muc_room(self) -> None:
        ...
        try:
            ...
            # Add MUC extension to request room features
            x = presence.addElement(("http://jabber.org/protocol/muc", "x"))
            
            # Request no history (we only want new messages)
            history = x.addElement("history")
